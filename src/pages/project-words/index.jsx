                    ...
                    <div className="field">
                      <div className="ui fluid left icon right action input">
                        <input
                            placeholder="Search..."
                            value={searchLeft}
                            onInput={this.handleInputSearchLeft.bind(this)}/>
                        <i className="icon search"/>
                        <button
                            className="ui icon button"
                            onClick={this.handleClickClearSearchLeftButton.bind(this)}>
                    ...
                    <div className="field">
                      <div className="ui fluid left icon right action input">
                        <input
                            placeholder="Search..."
                            value={searchRight}
                            oninput={this.handleInputSearchRight.bind(this)}/>
                        <i className="icon search"/>
                        <button
                            className="ui icon button"
                            onClick={this.handleClickClearSearchRightButton.bind(this)}>
                          <i className="icon remove"/>
                        </button>
                      </div>
                    </div>
