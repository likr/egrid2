  ...
  render () {
    ...
    return <div className='card'>
      ...
      <div className='extra content'>
        <Link className='ui secondary button' to={`/projects/${project.id}`}> Open
        </Link>
        <button
      ...
      <ProjectModal ref='projectModal' title='Update Project' onApprove={this.handleApproveProjectModal.bind(this)} />
    </div>
  }
